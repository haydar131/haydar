...
if y == 1:
	...
	os.system('figlet -f slant "Hayder"')
	...
	aaa=raw_input('entre Name lis (ex:hayder.txt) : ')
	os.system('clear')
	print(c)
	os.system('figlet -f script "B.hayder"')
	os.system('printf "\033[3;32m"')
	print('hayder Al-eyswy')
	print('<h=r>'*5)
	file=open(aaa,'w')
	aa=set([])
	oio=set([])
	...
	kk=1
	while True :
	    b=raw_input('Entre [pass]  {} : '.format(kk))
	    if kk==(10) :
	        print('\033[3;33m')
	        file.close()
	        qq=open(aaa, 'r' )
